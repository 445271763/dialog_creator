    ...
    ;(function($,window){
        ...
        var openDialog = function(param)
        {
            ...
            if (force)
            {
                ...
                $('.dialog-box' + index + ' .dialog-close-btn').remove();
            }
            else
            {
                $('.dialog-box' + index + ' .dialog-close-btn').on('click',function(){
                    var dialogBox = $(this).parents('.dialog-box');
                        dialogBox.fadeOut('fast',function(){dialogBox.remove()});
                    closeBg();
                });
        ...
        $(window).resize(function() {
            ...
            $('.dialog-box').each()
            {
                $(this).css('left',(viewSize.width-dialogWidth)/2 + 'px') ;
            }
